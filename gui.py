...
classes = { 
    0:'Thưa thầy mô hình nhận dạng đây là ảnh con mèo ạ!',
    1:'Thưa thầy mô hình nhận dạng đây là ảnh con chó ạ!',
 
}

top=tk.Tk()
top.geometry('800x600')
top.title('Nhận dạng chó mèo')
...
heading = Label(top, text="Nhận dạng chó mèo",pady=20, font=('arial',20,'bold'))
